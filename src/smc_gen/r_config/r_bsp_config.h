...
*         : 06.02.2017 1.11    Amended the following macro definition comment
...
*         : 27.07.2018 2.02    Modified the comment of USB PLL Input Frequency Divider Select.
...
*                               - BSP_CFG_USE_CGC_MODULE
*                              Modified the ICLK 24MHz to 32MHz.
...
*                               - BSP_CFG_LCD_CLOCK_SOURCE - Changed the default value from 2 to 5.
...
*                               - BSP_CFG_SWINT_UNIT1_ENABLE
*         : 28.02.2023 4.02    Modified comment.
***********************************************************************************************************************/
...
/* NOTE:
   The default settings are the same as when using RSKRX113.
...
*/
#define BSP_CFG_MCU_PART_PACKAGE        (0x9) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x5) /* Generated value. Do not edit this manually */

/* Group name.
   Character(s) = Description
   13           = RX113 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX113" /* Generated value. Do not edit this manually */
...
*/ 
#define BSP_CFG_USB_CLOCK_SOURCE        (1) /* Generated value. Do not edit this manually */
...
/* Sub-Clock Oscillator Drive Capacity Control (RTCDV).
   ...
   1 = Low drive capacity for low CL
   2 = Medium drive capacity for low CL
   3 = High drive capacity for low CL
*/
...
/* LCD Clock source select (LCDSCLKSEL).
   ...
   5 = LCD non use
*/
#define BSP_CFG_LCD_CLOCK_SOURCE        (5) /* Generated value. Do not edit this manually */

/* LCD Source Clock Output enable/disable Select.
    0 = LCD source clock output is disabled.
    1 = LCD source clock output is enabled.
*/
#define BSP_CFG_LCD_CLOCK_ENABLE        (0) /* Generated value. Do not edit this manually */
...
/* Clock configuration options.
   ...
   ICLK is 32MHz, PCLKB is 32MHz, FCLK is 32MHz, PCLKD is 32MHz, and CKO is 1MHz then the 
   settings would be:

   BSP_CFG_XTAL_HZ  = 16000000
   BSP_CFG_PLL_DIV  = 4        (divide by 4)
   BSP_CFG_PLL_MUL  = 8        (4MHz x 8 = 32MHz)
   BSP_CFG_UPLL_DIV = 2        (divide by 2)
   BSP_CFG_UPLL_MUL = 6        (8MHz x 6 = 48MHz)
...
*/
#define BSP_CFG_PLL_DIV                 (4) /* Generated value. Do not edit this manually */
...
/* USB PLL Input Frequency Divider Select (UPLIDIV).
   Available divisors = /1 (no division), /2
*/
...
/* USB PLL Frequency Multiplication Factor Select (USTC).
   Available multipliers = x6, x8
*/
#define BSP_CFG_UPLL_MUL                (6) /* Generated value. Do not edit this manually */
...
/* CLKOUT Output Frequency Division Ratio Select. (CKODIV)
   ...
   4 = x1/16
 */
#define BSP_CFG_CLKOUT_DIV              (1) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_CONFIGURATOR_VERSION                (2170) /* Generated value. Do not edit this manually */
