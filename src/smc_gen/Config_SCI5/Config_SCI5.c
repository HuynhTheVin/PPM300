...
void R_Config_SCI5_Create(void)
{
    ...
    SCI5.SMR.BYTE = _02_SCI_CLOCK_PCLK_16 | _00_SCI_MULTI_PROCESSOR_DISABLE | _00_SCI_STOP_1 | _00_SCI_PARITY_EVEN | 
                    _20_SCI_PARITY_ENABLE | _00_SCI_DATA_LENGTH_8 | _00_SCI_ASYNCHRONOUS_OR_I2C_MODE;
    SCI5.SCMR.BYTE = _00_SCI_SERIAL_MODE | _00_SCI_DATA_INVERT_NONE | _00_SCI_DATA_LSB_FIRST | _72_SCI_SCMR_DEFAULT;
    SCI5.SEMR.BYTE = _10_SCI_8_BASE_CLOCK | _00_SCI_NOISE_FILTER_DISABLE | _00_SCI_LOW_LEVEL_START_BIT;
